...
docker-compose -f docker-compose.yml up -d orderer.example.com ca.example.com  peer0.org1.example.com couchdb cli peer0.org2.example.com cli2 peer0.org3.example.com cli3
docker ps
